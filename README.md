# inViewPort
This simple script detect that element is on viewPort and executed callbacks .in, .out on enter or exit into viewport. Demo avaiable [jsfiddle.net/HlivSeTar/zhdohqd7](http://jsfiddle.net/HlivSeTar/zhdohqd7/).
